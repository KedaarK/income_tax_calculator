...
def create_sign_up_window():
    ...
    def submit():
        ...
        try:
            ...
            if row is not None:
                ...
                mycursor.execute(query, (
                first_name, middle_name, last_name, mother_name, dob_entry.get(), age, gender_combobox.get(),
                mobile_number, gmail, state, district, city, society_street, password))
    ...
    state_label = ttk.Label(label_frame, text="State:")  # Change text color as needed
    ...
    district_label = ttk.Label(label_frame, text="District:")  # Change text color as needed
    ...
    # Manually define entry fields with labels
    first_name_label = ttk.Label(label_frame, text="First Name:")  # Change text color as needed
    first_name_label.grid(row=0, column=0, padx=5, pady=5)
    first_name_entry = ttk.Entry(label_frame)
    first_name_entry.grid(row=0, column=1, padx=5, pady=5)

    middle_name_label = ttk.Label(label_frame, text="Middle Name:")  # Change text color as needed
    ...
    last_name_label = ttk.Label(label_frame, text="Last Name:")  # Change text color as needed
    ...
    mother_name_label = ttk.Label(label_frame, text="Mother's Name:")  # Change text color as needed
    ...
    dob_label = ttk.Label(label_frame, text="Date of Birth (YYYY-MM-DD):")  # Change text color as needed
    ...
    gender_label = ttk.Label(label_frame, text="Gender:")  # Change text color as needed
    ...
    mobile_label = ttk.Label(label_frame, text="Mobile Number:")  # Change text color as needed
    ...
    gmail_label = ttk.Label(label_frame, text="Gmail:")  # Change text color as needed
    ...
    city_label = ttk.Label(label_frame, text="City:")  # Change text color as needed
    ...
    society_street_label = ttk.Label(label_frame, text="Society and Street:")  # Change text color as needed
    ...
    password_label = ttk.Label(label_frame, text="Create Password:")  # Change text color as needed
    password_label.grid(row=13, column=0, padx=5, pady=5)
    password_entry = ttk.Entry(label_frame, show="*")
    password_entry.grid(row=13, column=1, padx=5, pady=5)

    age_label = ttk.Label(label_frame, text="Age:")  # Change text color as needed
